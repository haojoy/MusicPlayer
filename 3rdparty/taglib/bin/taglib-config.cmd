...
:doit
if /i "%1#" == "--libs#"    echo -LD:/BuildLibs/taglib-master/build/output/lib -llibtag
if /i "%1#" == "--cflags#"  echo -ID:/BuildLibs/taglib-master/build/output/include -ID:/BuildLibs/taglib-master/build/output/include/taglib
if /i "%1#" == "--version#" echo 2.0.1
if /i "%1#" == "--prefix#"  echo D:/BuildLibs/taglib-master/build/output
